...
public class CBrowserWindow7 extends ACEDESBrowserWindow7 {
	...
	public void onPageFinished(WebView view, String url) {
		...
		if (bWindow != null && bWindow.getWidget().m_appdebug == 1) {
			String debugUrlString = "http://" + bWindow.getWidget().m_logServerIp
	...
	public void onDownloadStart(Context context, String url, String userAgent, String contentDisposition,
		...
		if (contentDisposition == null || !contentDisposition.regionMatches(true, 0, "attachment", 0, 10)) {
			...
			if (checkInstallApp(context, installIntent)) {
				try {
					...
					e.printStackTrace();
					Toast.makeText(context, EUExUtil.getString("can_not_find_suitable_app_perform_this_operation"),
	...
	private boolean checkInstallApp(Context context, Intent target) {
		...
		List<ResolveInfo> list = packageManager.queryIntentActivities(target, PackageManager.MATCH_DEFAULT_ONLY);
